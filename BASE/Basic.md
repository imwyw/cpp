...
<a id="markdown-指针数组" name="指针数组"></a>
### 指针数组
todo 有空整理
...
[C++中的结构体](http://blog.csdn.net/cainv89/article/details/48447225)


[C++中函数返回值能否是数组？](https://blog.csdn.net/modeala_/article/details/17481569)
